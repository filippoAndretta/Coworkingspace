...
import ch.zli.m223.service.CwSUserService;
...
public class CwSUserController {
    ...
    @PermitAll
    public CwSUser create(CwSUser user) {
        return cwSUserService.createUser(user);
    }
    ...
    public CwSUser update(@PathParam("id") Long id, CwSUser user) {
        return cwSUserService.updatUser(id, user);
    }
}
